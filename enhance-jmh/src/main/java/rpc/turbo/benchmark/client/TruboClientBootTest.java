...
@SpringBootApplication(scanBasePackages = { "rpc.zhushimmer.benchmark.service", "rpc.zhushimmer.benchmark.client" })
@EnableTurboClient
public class TruboClientBootTest {
	...
	public void test() {
		...
		boolean existUser = userService.existUser("zhushimmer.whu@gmail.com").join();
		System.out.println(existUser);
		System.out.println("=====================");
		System.out.println();
